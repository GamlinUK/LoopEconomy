...
public class GemsEconomy extends JavaPlugin {
    ...
    public void onEnable() {
        ...
        getCommand("gems").setExecutor(new BalanceCommand());
        getCommand("gemtop").setExecutor(new BalanceTopCommand());
        getCommand("gemeconomy").setExecutor(new EconomyCommand());
        getCommand("gempay").setExecutor(new PayCommand());
